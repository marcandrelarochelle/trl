...
class GRPOTrainer(Trainer):
    ...
    def iterable_data_collator(self, features):
        ...
        """
        return [x for x in features for _ in range(self.num_generations) for _ in range(self.num_iterations * self.args.steps_per_generation)]  # The duplication happens on the fly.
